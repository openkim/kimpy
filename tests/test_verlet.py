...
energy_ref2 = 180.424660358
forces_ref2 = np.array([[ -93.39654141,  -92.82724527,  -92.82724527],
                        [  -0.58130133,  139.2406559 , -139.2406559 ],
                        [  -0.58130133, -139.2406559 ,  139.2406559 ],
                        [ -93.39654141,   92.82724527,   92.82724527],
                        [   0.58130133, -139.2406559 , -139.2406559 ],
                        [  93.39654141,   92.82724527,  -92.82724527],
                        [  93.39654141,  -92.82724527,   92.82724527],
                        [   0.58130133,  139.2406559 ,  139.2406559 ]])
...
def test_forces():
  ...
  for i in range(10):
    ...
    tol = 1e-6
    assert energy == pytest.approx(energy_ref2, tol)
    assert forces == pytest.approx(forces_ref2, tol)
